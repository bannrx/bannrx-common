...
public class UserServiceTest {
    ...
    public void setUp(){
        validRequest  =
                new SignUpRequest("Saurav", "1234567890", "saurav@gmail.com", "password@123", UserRole.ROLE_CAMPAIGNER,
                        ...
                        Set.of(new BankDetailsDto("BN12345","12345","PNB1245",true,"123456")),
    ...
    public void testToEntitySet() throws ServerException{
        ...
        Set<BankDetailsDto> bankDetailsDtoSet = Set.of(new BankDetailsDto("BN12345","12345","PNB1245",true,"123456"));
